...
3. 最新ニュースが2暦日以上前なら、茨城県・44市町村・交通・主要施設・SPORTS・地域経済の公式一次情報を確認する。公開価値のある新情報があれば、Growth Batchとは別のNews Deskレーンで同日中に新規公開または既存記事を更新する。該当情報がなければ「公開価値のある新情報なし」と記録し、穴埋め記事は作らない
...
- 最新公開が2暦日以上前なら、公式一次情報を再走査し、公開価値のある新情報の有無を明示する
- 公開価値がある情報は、title、description、本文、一次情報URL、確認日、内部リンク、CTA、構造化データ、公開後確認まで完成させて実装する
- 数合わせの記事、公式発表の言い換えだけの記事、未確認情報、既存記事と同じ検索意図の記事は作らない
